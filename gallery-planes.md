...
| **F** | faces South (+Z) | Z=-42.9 | 42 |
| **G** | faces West (−X) | X=-3.7 | 63 |
| **H** | faces East (+X) | X=3.7 | 58 |
| **I** | faces East (+X) | X=-3.0 | 66 |
| **J** | faces West (−X) | X=3.0 | 65 |
| **K** | faces North (−Z) | Z=-33.2 | 4, 5, 6 |
| **L** | faces South (+Z) | Z=-32.8 | 50, 51, 52 |
| **M** | faces West (−X) | X=-20.2 | 31, 32 |
| **N** | faces East (+X) | X=-19.4 | 29, 30 |
| **O** | faces West (−X) | X=19.4 | 25, 26 |
| **P** | faces East (+X) | X=20.2 | 27, 28 |
| **Q** | faces North (−Z) | Z=-21.9 | 47, 48, 49 |
| **R** | faces South (+Z) | Z=-21.5 | 1, 2, 3 |
| **S** | faces East (+X) | X=-30.3 | 36, 37, 43, 44, 45 |
| **T** | faces West (−X) | X=30.3 | 33, 34, 39, 40, 41 |
| **U** | faces East (+X) | X=-24.0 | 23 |
| **V** | faces East (+X) | X=5.5 | 18 |
| **W** | faces West (−X) | X=-5.5 | 24 |
